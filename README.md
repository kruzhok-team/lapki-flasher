...
| ms-ping-result     | deviceID, code (int), comment                                                                              | результат пинга code 0: пришёл обратный ответ (понг) code 1: устройство не найдено  code 2: ошибка пингования code 3: неправильный тип устройства (тип устройства не может выполнить эту операцию) code 4: не удалось распарсить JSON-сообщение;                                                                                                                                         | сервер   |
| ms-get-address     | deviceID                                                                                                   | запрос на получения адреса                                                                                                                                                                                                                                                                                                                                                               | клиент   |
| ms-address         | deviceID, code (int), comment                                                                              | получение адреса МС-ТЮК клиентом  code 0: получен адрес, в comment содержится адрес code 1: устройство не найден code 2: получена ошибка при попытке узнать адрес, в comment содержится текст ошибки code 3: неправильный тип устройства (тип устройства не может выполнить эту операцию) code 4: не удалось распарсить JSON-сообщение;                                                  | сервер   |
...
| ms-reset-result    | deviceID, code (int), comment                                                                              | Результат ms-reset code 0: сброс произошёл успешно code 1: устройство не найдено code 2: ошибка при сбросе устройства, comment может содержать текст ошибки code 3: неправильный тип устройства (тип устройства не может выполнить эту операцию) code 4: не удалось распарсить JSON-сообщение;                                                                                           | сервер   |
| ms-get-meta-data   | deviceID, address                                                                                          | запрос на получение метаданных МС-ТЮК                                                                                                                                                                                                                                                                                                                                                    | клиент   |
| ms-meta-data       | deviceID, RefBlHw, RefBlFw, RefBlUserCode, RefBlChip, RefBlProtocol, RefCgHw, RefCgFw, RefCgProtocol, type | Метаданные платы, где deviceID - это ID МС-ТЮК, type - это тип платы, а всё отсальное - доп. информация                                                                                                                                                                                                                                                                                  | сервер   |
...
| flash-backtrack-ms | UploadStage, NoPacks(bool), CurPack(uint16), TotalPacks(uint16)                                            | обратная связь от программы загрузки прошивки МС-ТЮК                                                                                                                                                                                                                                                                                                                                     |          |