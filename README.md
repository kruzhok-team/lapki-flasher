...
| serial-sent-status       | deviceID, code (int), comment | Сведения о последнем отправленном на deviceID сообщении:  code = 0: сообщение было отправлено успешно;  code = 1: сообщение не удалось отправить; code = 2: устройство с deviceID отсутствует в списке устройств (сервер самостоятельно отправит сообщение device-update-delete); comment - дополнительное сообщение, содержит текст ошибки.                                                                                                                                                                   | сервер |
