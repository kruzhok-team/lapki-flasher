...
| Сообщение                | Параметры                     | Описание                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |        |
|--------------------------|-------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| serial-log               | msg                           | Сообщение от serial monitor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | сервер |
| serial-connect           | deviceID, baud                | Подключиться к устройству deviceID со скростью baud.  Автоматически разорвёт предыдущее соединение с deviceID, если оно было.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | клиент |
| serial-connection-status | deviceID, code (int), comment | code = 0: установлено подключение к устройству deviceID;  code = 1: не удалось открыть монитор порта;  code = 2: устройство с deviceID отсутствует в списке устройств (сервер самостоятельно отправит сообщение device-update-delete);  code = 3: попытка открыть монитор порта для фальшивого устройства;  code = 4: не удалось распарсить JSON-сообщение;   code = 5: устройство занято прошивкой;  code = 6: монитор порта уже открыт;   code = 7: закрытие порта, ошибка чтения;  code = 8: закрытие монитора порта по запросу клиента;  comment - дополнительное сообщение, содержит текст ошибки.   Этот тип сообщения автоматически отправляется сервером при изменении статуса соединения. | сервер |
...
| serial-sent-status       | deviceID, code (int), comment | Сведения о последнем отправленном на deviceID сообщении:   code = 0: сообщение было отправлено успешно;   code = 1: сообщение не удалось отправить;  code = 2: устройство с deviceID отсутствует в списке устройств (сервер самостоятельно отправит сообщение device-update-delete);  code = 3: не удалось отправить сообщение, так как монитор порта закрыт;  code = 4: не удалось распарсить JSON-сообщение;  comment - дополнительное сообщение, содержит текст ошибки.                                                                                                                                                                                                                         | сервер |
| serial-device-msg        | deviceID, msg                 | Сообщение от устройства deviceID.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | сервер |                                                                                                                                                                                                                                                                                                                                                                                                               | сервер |