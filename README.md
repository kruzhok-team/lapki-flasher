...
| ms-get-firmware            | deviceID, address                                                                                                                                     | Запрос на выгрузку прошивки из платы МС-ТЮК                                                                                                                                                                                                                                                                                                                                              | клиент   |
...
| ms-get-firmware-finish     | deviceID, address, code(int), comment                                                                                                                 | Результат выгрузки прошивки из МС-ТЮК:<br>code 0: все бинарные данные прошивки были доставлены клиенту<br>code 1: устройство не найдено<br>code 2: неправильный тип устройства<br>code 3: получена ошибка<br>code 4?: timeout - клиент слишком долго не отправлял бинарные данные                                                                                                        | сервер   |
