...
- `-avrdudePath`: путь к avrdude (напишите avrdude, если нужно, чтобы использовался системный путь) (по-умолчанию avrdude.exe)
- `-configPath`: путь к файлу конфигурации avrdude (по-умолчанию '')
