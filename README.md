...
Если устройство прошивается через bootloader (как Arduino Micro), то это значит, что оно состоит из двух устройств, каждому необходимо представить своё описание, при этом основное устройство должно ссылаться на bootloader версию, а сам bootloader, не должен ссылаться на что-либо (см. описания Arduino Micro и Arduino Micro (booltloader) в файле со списком устройств).
