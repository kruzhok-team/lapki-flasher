...
- hasBootloader: если true, то считается, что описание устройства, которое добавлено ниже является bootloader для текущего типа устройств(см. раздел "Добавление bootloader"). 
