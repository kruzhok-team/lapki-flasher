...
| serial-sent-status       | deviceID, hasSent (bool), comment     | Сведения о последнем отправленном на deviceID сообщении: hasSent = true, если сообщение было отправлено успешно; comment - доплнительное сообщение, содержит текст ошибки.                                  | сервер |
