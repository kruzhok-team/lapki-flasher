...
func setArgs() {
	...
	flag.IntVar(&fakeBoards, "stub", 0, "количество ненастоящих, симулируемых устройств, которые будут восприниматься клиентом как настоящие, применяется для тестирования")
